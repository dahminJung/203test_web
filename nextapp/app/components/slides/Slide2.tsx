    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-white px-8 text-center">
      <div className="max-w-2xl space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-4xl md:text-6xl font-black leading-tight text-black">
            바로 <span className="underline decoration-4 underline-offset-4">여러분</span>입니다.
          </p>
        </div>
...
{`  ___________________________
 ...
 |___________________________|`}
        ...
        <div className="border-2 border-black rounded-2xl p-6 text-left space-y-3">
          <p className="text-lg leading-relaxed text-gray-700">
            공약을 안 지키는 일이 너무 많죠.
          </p>
          <p className="leading-relaxed text-gray-600">
            그래서 저는 화려한 공약 대신,{" "}
            <span className="font-semibold text-black">여러분의 목소리를 듣는 것</span>을
            첫 번째 약속으로 삼겠습니다.
          </p>
        </div>
